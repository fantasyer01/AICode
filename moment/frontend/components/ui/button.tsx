  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        lavender: "bg-lavender-light text-lavender hover:bg-lavender hover:text-primary-foreground",
        mint: "bg-mint-light text-mint hover:bg-mint hover:text-primary-foreground",
        rose: "bg-rose-light text-rose hover:bg-rose hover:text-primary-foreground",
        glass: "bg-card/60 backdrop-blur-md border border-border/50 hover:bg-card/80 hover:border-primary/30",
      },
      size: {
